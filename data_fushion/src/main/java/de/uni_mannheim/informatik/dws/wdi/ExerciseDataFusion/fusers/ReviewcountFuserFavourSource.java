...
/**
 * {@link AttributeValueFuser} for the director of {@link Restaurant}s.
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class ReviewcountFuserFavourSource extends AttributeValueFuser<String, Restaurant, Attribute> {

	public ReviewcountFuserFavourSource() {
	...
	public void fuse(RecordGroup<Restaurant, Attribute> group, Restaurant fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setReviewcount(fused.getValue());
		fusedRecord.setAttributeProvenance(Restaurant.REVIEWCOUNT,

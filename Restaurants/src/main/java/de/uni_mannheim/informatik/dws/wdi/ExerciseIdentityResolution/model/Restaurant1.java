 ...
 * 
 */
public class Restaurant1 extends AbstractRecord<Attribute> implements Serializable {
	...
	public Restaurant1(String identifier, String provenance) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Restaurant1 other = (Restaurant1) obj;
		if (name == null) {
			if (other.name != null)
				return false;

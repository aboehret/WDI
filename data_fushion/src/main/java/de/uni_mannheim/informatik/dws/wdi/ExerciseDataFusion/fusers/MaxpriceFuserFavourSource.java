...
public class MaxpriceFuserFavourSource extends AttributeValueFuser<Integer, Restaurant, Attribute> {

	public MaxpriceFuserFavourSource() {
	...
	public void fuse(RecordGroup<Restaurant, Attribute> group, Restaurant fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setMaxprice(fused.getValue());
		fusedRecord.setAttributeProvenance(Restaurant.MAXPRICE, fused.getOriginalIds());
	}

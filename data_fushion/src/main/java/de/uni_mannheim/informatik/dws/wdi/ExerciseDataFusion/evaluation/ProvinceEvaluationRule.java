 ...
 * 
 */
public class ProvinceEvaluationRule extends EvaluationRule<Restaurant, Attribute> {

	@Override
	public boolean isEqual(Restaurant record1, Restaurant record2, Attribute schemaElement) {
		if(record1.getProvince()== null && record2.getProvince()==null)
			return true;
		else if(record1.getProvince()== null ^ record2.getProvince()==null)
			return false;
		else 
			return record1.getProvince().equals(record2.getProvince());
	}

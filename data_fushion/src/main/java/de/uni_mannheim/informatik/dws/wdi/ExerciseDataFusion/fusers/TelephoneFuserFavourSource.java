 ...
 * 
 */
public class TelephoneFuserFavourSource extends AttributeValueFuser<String, Restaurant, Attribute> {

	public TelephoneFuserFavourSource() {
	...
	public void fuse(RecordGroup<Restaurant, Attribute> group, Restaurant fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setTelephone(fused.getValue());
		fusedRecord.setAttributeProvenance(Restaurant.TELEPHONE,

...
//		SortedNeighbourhoodBlocker<Movie, Attribute, Attribute> blocker = new SortedNeighbourhoodBlocker<>(new MovieBlockingKeyByTitleGenerator(), 1);
		...
		Processable<Correspondence<Movie, Attribute>> correspondences = engine.runIdentityResolution(
				dataAcademyAwards, dataActors, null, matchingRule, // Here we pass the 2 data records and the matching rule we have created
				blocker);
...
//		 Alternative: Create a maximum-weight, bipartite matching
		...
		// Correspondences means the pairs that is compared to check if it referring to the same entity or not

...
import de.uni_mannheim.informatik.dws.wdi.ExerciseDataFusion.evaluation.CuisineEvaluationRule;
...
import de.uni_mannheim.informatik.dws.wdi.ExerciseDataFusion.fusers.CuisineFuserUnion;
import de.uni_mannheim.informatik.dws.wdi.ExerciseDataFusion.fusers.NameFuserLongestString;
import de.uni_mannheim.informatik.dws.wdi.ExerciseDataFusion.fusers.WebsiteFuserFavourSource;
...
public class Restaurant_DataFusion_Test 
{
	/*
	 * Logging Options:
	...
	public static void main( String[] args ) throws Exception
    {
		...
		correspondences.loadCorrespondences(new File("data/correspondences/michelin_tripadvisor_correspondences_test.csv"),ds1, ds2);
		correspondences.loadCorrespondences(new File("data/correspondences/bookuber_tripadvisor_correspondences_test.csv"),ds2, ds3);
		...
		strategy.addAttributeFuser(Restaurant.CUISINE,new CuisineFuserUnion(), new CuisineEvaluationRule());
		strategy.addAttributeFuser(Restaurant.WEBSITE,new WebsiteFuserFavourSource(), new WebsiteEvaluationRule());
		...
		engine.writeRecordGroupsByConsistency(new File("data/output/recordGroupConsistencies_.csv"), correspondences, null);

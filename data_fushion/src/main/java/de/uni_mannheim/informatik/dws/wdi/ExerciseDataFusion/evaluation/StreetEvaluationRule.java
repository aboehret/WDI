 ...
 * 
 */
public class StreetEvaluationRule extends EvaluationRule<Restaurant, Attribute> {

	@Override
	public boolean isEqual(Restaurant record1, Restaurant record2, Attribute schemaElement) {
		if(record1.getStreet()== null && record2.getStreet()==null)
			return true;
		else if(record1.getStreet()== null ^ record2.getStreet()==null)
			return false;
		else 
			return record1.getStreet().equals(record2.getStreet());
	}

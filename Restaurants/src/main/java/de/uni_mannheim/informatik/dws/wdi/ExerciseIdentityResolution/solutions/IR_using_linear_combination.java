...
public class IR_using_linear_combination 
{
    ...
    public static void main( String[] args ) throws Exception
    {
		...
		new RestaurantXMLReader().loadFromXML(new File("data/input/michelin_target_schema.xml"), "/restaurants/restaurant", dataMichelin);
		HashedDataSet<Restaurant, Attribute> dataTA = new HashedDataSet<>();
		new RestaurantXMLReader().loadFromXML(new File("data/input/TA_target_schema.xml"), "/restaurants/restaurant", dataTA);

...
public class IR_using_linear_combination_Michelin_and_TA 
{
	/*
	 * Logging Options:
    ...
    public static void main( String[] args ) throws Exception
    {
		...
		matchingRule.activateDebugReport("data/output/debugResultsMatchingRuleRestaurant_Michelin_Tripadvisor.csv", 1001, gsTest); 
...
//		SortedNeighbourhoodBlocker<Movie, Attribute, Attribute> blocker = new SortedNeighbourhoodBlocker<>(new MovieBlockingKeyByTitleGenerator(), 1);
		...
		blocker.collectBlockSizeData("data/output/debugResultsBlocking_Michelin_Tripadvisor.csv", 100);
...
//		 Alternative: Create a maximum-weight, bipartite matching
		...
		new CSVCorrespondenceFormatter().writeCSV(new File("data/output/Restaurant_correspondences_Michelin_Tripadvisor.csv"), correspondences);
		...
		logger.info("Michelin <-> Trip_advisor");

 ...
 * 
 */
public class ProvinceFuserVoting extends AttributeValueFuser<String, Restaurant, Attribute> {

	public ProvinceFuserVoting() {
	...
	public void fuse(RecordGroup<Restaurant, Attribute> group, Restaurant fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setProvince(fused.getValue());
		fusedRecord.setAttributeProvenance(Restaurant.PROVINCE,

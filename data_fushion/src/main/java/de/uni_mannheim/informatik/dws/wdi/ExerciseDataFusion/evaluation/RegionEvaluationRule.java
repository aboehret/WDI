 ...
 * 
 */
public class RegionEvaluationRule extends EvaluationRule<Restaurant, Attribute> {
	...
	public boolean isEqual(Restaurant record1, Restaurant record2, Attribute schemaElement) {
		if(record1.getRegion()== null && record2.getRegion()==null)
			return true;
		else if(record1.getRegion()== null ^ record2.getRegion()==null)
			return false;
		else 
			return record1.getRegion().equals(record2.getRegion());
	}

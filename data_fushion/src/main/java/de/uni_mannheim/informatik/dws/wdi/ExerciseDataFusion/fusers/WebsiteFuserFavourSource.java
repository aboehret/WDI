 ...
 * 
 */
public class WebsiteFuserFavourSource extends AttributeValueFuser<String, Restaurant, Attribute> {

	public WebsiteFuserFavourSource() {
	...
	public void fuse(RecordGroup<Restaurant, Attribute> group, Restaurant fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Restaurant.WEBSITE,
